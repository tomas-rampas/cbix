...
/// <summary>
/// Scenario-scoped state for <c>Features/GenericVisionDocumentContentProfile.feature</c> (story
/// S01-06). A dumb typed carrier, as elsewhere: the steps own the behaviour, this owns only what
/// has to survive between them.
/// </summary>
public sealed class GenericVisionProfileState
{
